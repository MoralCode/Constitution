...
\renewcommand{\theenumi}{\alph{enumi}} % For this section, we want items to use letters
\begin{enumerate}
	\item Sign the Membership Agreement sheets pertaining to the responsible utilization of Computer Science House and Rochester Institute of Technology facilities.
...
\asubsubsection{Membership Agreement}
The Membership Agreement located at \url{https://github.com/ComputerScienceHouse/MembershipAgreement} is the canonical Membership Agreement for Computer Science House accounts.
\\* \\*
Members are bound to the Membership Agreement revision that they sign when initially creating their account.
Members may update the terms of their agreement by signing a more recent revision of the Membership Agreement.
\asubsubsubsection{Changes}
The following process is used for making changes to the Membership Agreement document.
\begin{enumerate}
	\item A Root Type Person drafts a change to the Membership Agreement and makes publicly available both the summary and difference file of the change.
